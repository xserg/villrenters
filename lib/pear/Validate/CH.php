...
// +----------------------------------------------------------------------+
//
// $Id: CH.php 70 2011-04-11 07:15:31Z xxserg@gmail.com $

/**
* Validation functions for Swiss IDs 
*
* @version   $Id: CH.php 70 2011-04-11 07:15:31Z xxserg@gmail.com $
    ...
    */
    function postcode($postcode, $strong=false)
    {
        if ($strong) {
            ...
            if (!isset($postcodes)) {
                $file = '/usr/local/lib/php/data/Validate/CH_postcodes.txt';
